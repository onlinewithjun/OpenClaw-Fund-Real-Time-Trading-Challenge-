#!/bin/bash
# 修复 data_mining 的 BUILD.gn - 添加本目录 include
...
echo "Fixed BUILD.gn - added current directory include"

# 检查外层 BUILD.gn 是否已包含 data_mining
echo ""
echo "Checking outer BUILD.gn for data_mining dependency:"
grep -A2 -B2 'data_mining' /home/lizhuojun/workspace/oh/foundation/distributeddatamgr/datamgr_service/services/distributeddataservice/service/BUILD.gn
